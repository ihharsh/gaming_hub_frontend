...
function Groups() {
  ...
  useEffect(() => {
    ...
    axios
      .get("https://gaming-hub-project.onrender.com/chat/fetchGroups", config)
      .then((response) => {
  ...
  const handleUpdateUsername = async () => {
    ...
    try {
      await axios.put(
        "https://gaming-hub-project.onrender.com/user/updateUsername",
        {
          userId: user._id,
            ...
            return (
              <motion.div
                ...
                onClick={() => {
                  ...
                  axios.post(
                    "https://gaming-hub-project.onrender.com/chat/",
                    {
                      userId: user._id,
                    },
                    config
